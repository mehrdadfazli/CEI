...
cmd="python run_MMHal.py --config \"$CONFIG_FILE\" --input \"$INPUT_JSON\" --images_root \"$IMAGES_ROOT\" --log_dir \"$LOG_DIR\""
cmd="$cmd --gpu_id ${gpu_id:-0} --max_new_tokens ${max_new_tokens:-512}"
