...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Optional JSON path: evaluation_type and raw metric counters (after scoring).',
    )
...
def main(args):
    ...
    if args.summary_file:
        ...
        with open(args.summary_file, "w", encoding="utf-8") as sf:
            json.dump({"evaluation_type": args.evaluation_type, "metrics": metrics}, sf, indent=2)
